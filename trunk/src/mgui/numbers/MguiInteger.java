...
/*********************************************************
 * Implementation of {@link MguiNumber} for values of type <code>int</code>.
 * 
 * @author Andrew Reid
 * @version 1.0
 * @since 1.0
 *
 */
public class MguiInteger implements MguiNumber {

	protected int value;
	
	public MguiInteger(){}
	
	public MguiInteger(int thisValue){
		value = thisValue;
	}
	...
	public MguiInteger(String thisValue){
		Integer i = Double.valueOf(thisValue).intValue();
		if (i == null){
			value = 0;
			return;
			}
		value = (int)Math.round(i);
	}
	
	public MguiInteger(double value){
	...
	public MguiNumber divide(MguiNumber number){
		value = (int)((double)value / number.getValue());
		return this;
	}
