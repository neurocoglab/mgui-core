...
/*********************************************************
 * Implementation of {@link MguiNumber} for values of type <code>long</code>.
 * 
 * @author Andrew Reid
 * @version 1.0
 * @since 1.0
 *
 */
public class MguiLong implements MguiNumber {
	...
	public MguiLong(String thisValue){
		Integer i = Integer.decode(thisValue);
		if (i == null){
			value = 0;
			return;
			}
	...
	public MguiNumber divide(MguiNumber number){
		value = (long)((double)value / number.getValue());
		return this;
	}
	...
	public static String getString(int thisVal, String pattern){
		return (new MguiLong(thisVal)).toString(pattern);
	}
