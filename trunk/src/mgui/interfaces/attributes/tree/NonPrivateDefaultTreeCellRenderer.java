 ...
 * @author Scott Violet
 */
public class NonPrivateDefaultTreeCellRenderer extends JLabel implements TreeCellRenderer
{
    ...
    protected void paintFocus(Graphics g, int x, int y, int w, int h, Color notColor) {
