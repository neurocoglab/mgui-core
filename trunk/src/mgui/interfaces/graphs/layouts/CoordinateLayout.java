 ...
 * @param <E>
 */
public class CoordinateLayout<V extends AbstractGraphNode, E extends AbstractGraphEdge> extends AbstractLayout<V,E> {
	 ...
	 * 
	 */
	public CoordinateLayout(Graph<V, E> g) {
		this(g, new Plane3D(new Point3f(0,0,0), 
							new Vector3f(1,0,0), 
							new Vector3f(0,-1,0)));
	}
	
	public CoordinateLayout(Graph<V, E> graph, Plane3D projection_plane) {
		super(graph);
