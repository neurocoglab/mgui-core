...
public class LocalToWindow {
	...
	if ((this.canvas != null) && (this.node != null)) {
	    ...
	    //InterfaceSession.log("eyePos = " + eyePos);
	    ...
	    //InterfaceSession.log("canvasScr = " + canvasScr);
	    ...
	    metersPerPixelX = physicalScreenWidth / screenSize.width;
	    metersPerPixelY = physicalScreenHeight / screenSize.height;
	}
    }
	...
	//InterfaceSession.log("vWorld Pt = " + localPt);

	localToImagePlate.transform(localPt, imagePlatePt);
	//InterfaceSession.log("imagePlatePt = " + imagePlatePt);
	...
	if (projType == View.PERSPECTIVE_PROJECTION) {
	    ...
	    //InterfaceSession.log("eye dist = " + (eyePos.z));
	    //InterfaceSession.log("image dist = " + (-projVec.z));
	...
	//InterfaceSession.log("screenPt = " + screenPt);
	...
	windowPt.y = screenSize.height - 1 - (screenPt.y / metersPerPixelY) - 
		canvasScr.y;
	//InterfaceSession.log("windowPt = " + windowPt);
