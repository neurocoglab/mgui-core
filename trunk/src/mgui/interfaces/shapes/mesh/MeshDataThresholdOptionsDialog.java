...
public class MeshDataThresholdOptionsDialog extends InterfaceOptionsDialogBox {

	InterfaceDialogUpdater updater;
	LineLayout lineLayout;
	
	JCheckBox chkMin = new JCheckBox("Retain value:");
	JTextField txtMin = new JTextField("1"); 
	JCheckBox chkMax = new JCheckBox("Remove value:");
	JTextField txtMax = new JTextField("0"); 
	...
	public MeshDataThresholdOptionsDialog(){
		super();
	}
	
	public MeshDataThresholdOptionsDialog(JFrame aFrame, MeshDataThresholdOptions options){
