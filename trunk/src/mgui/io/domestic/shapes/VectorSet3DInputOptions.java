...
/*******************************************************
 * Options for loading a {@linkplain VectorSet3DInt} object. 
 * 
 * @author Andrew Reid
 * @version 1.0
 * @since 1.0
 *
 */
public class VectorSet3DInputOptions extends ShapeInputOptions {
	...
	public VectorSet3DInputOptions(){
	...
	public JFileChooser getFileChooser(File f) {
		...
		fc.setDialogTitle("Select vector files to input");
		return fc;
	}
