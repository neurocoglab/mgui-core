...
public class PointSet3DDataInputOptions extends InterfaceIOOptions {

	public PointSet3DInt pointset;
	public String[] names;
	public File[] files;
	...
	public JFileChooser getFileChooser(File f){
		...
		fc.setDialogTitle("Select point set 3D data files to input");
		return fc;
	}
