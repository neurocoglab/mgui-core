...
public class PointSet2DInputDialogBox extends InterfaceIODialogBox {

	protected JLabel lblSectionSet = new JLabel("Add to section set:");
	JComboBox cmbSectionSet = new JComboBox();
	JLabel lblSection = new JLabel("Section:");
	JTextField txtSection = new JTextField("0");
	protected JLabel lblPolysets = new JLabel("Point sets:");
	...
	public PointSet2DInputDialogBox(){
		super();
		init();
	}
	
	public PointSet2DInputDialogBox(JFrame frame, InterfaceIOPanel panel, InterfaceIOOptions opts){
	...
	protected void init(){
		...
		this.setTitle("PointSet 2D Input Options");
		...
		c = new LineLayoutConstraints(2, 2, 0.4, 0.45, 1);
	...
	public void showDialog(){
		PointSet2DInputOptions opts = (PointSet2DInputOptions)options;
		if (opts == null) opts = new PointSet2DInputOptions();
		
		updateCombo();
		
		cmbSectionSet.setSelectedItem(opts.section_set);
		txtSection.setText("" + opts.section);
	...
	public void actionPerformed(ActionEvent e){
		...
		if (e.getActionCommand().equals(DLG_CMD_OK)){
			...
			PointSet2DInputOptions opts = (PointSet2DInputOptions)options;
			opts.section_set = (SectionSet3DInt)cmbSectionSet.getSelectedItem();
			opts.section = Integer.valueOf(txtSection.getText());
