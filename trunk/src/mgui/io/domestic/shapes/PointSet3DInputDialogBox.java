...
public class PointSet3DInputDialogBox extends InterfaceIODialogBox {
	...
	public PointSet3DInputDialogBox(){
		super();
		init();
	}
	
	public PointSet3DInputDialogBox(JFrame frame, InterfaceIOPanel panel, InterfaceIOOptions opts){
		super(frame, panel, opts);
		((PointSet3DInputOptions)opts).shapeSet = InterfaceSession.getDisplayPanel().getCurrentShapeSet();
		init();
	}
	...
	protected void init(){
		...
		this.setTitle("PointSet 3D Input Options");
	...
	public void showDialog(){
		PointSet3DInputOptions opts = (PointSet3DInputOptions)options;
		if (opts == null) opts = new PointSet3DInputOptions();
