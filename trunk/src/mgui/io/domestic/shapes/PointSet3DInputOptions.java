...
/*******************************************************
 * Options for loading a {@linkplain PointSet3DInt} object. 
 * 
 * @author Andrew Reid
 * @version 1.0
 * @since 1.0
 *
 */
public class PointSet3DInputOptions extends ShapeInputOptions {
	...
	public JFileChooser getFileChooser(File f) {
		...
		fc.setDialogTitle("Select 3D point set files to input");
		return fc;
	}
