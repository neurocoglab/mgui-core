...
public class Context {
	...
	try {
	    ...
	    InterfaceSession.log("Exception " + e + " writing attrs");
	}
    }
	...
	try {
		...
		vrsdat = new URL( codebase + filename );
		    ...
		    InterfaceSession.log("VolFile: " + e.getMessage());
	    }
		...
		//InterfaceSession.log("setting attr " + name + " to " + value);
	    ...
	    InterfaceSession.log("Exception " + e + " reading attrs");
	}
	return description;
    }
